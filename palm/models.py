...
class Gcg(models.Model):
    ...
    state = models.CharField(choices=STATE_TYPE, max_length=2)
...
class ControlOpenOption(models.Model):
    ...
    om_mode = models.CharField(choices=MODE_TYPE, max_length=2)
    om_delay_time = models.IntegerField() # 단위 : 초
    om_open_sequence = models.CharField(choices=SEQUENCE_TYPE, max_length=2)
    om_close_sequence = models.CharField(choices=SEQUENCE_TYPE, max_length=2)
    om_rain_mode = models.CharField(choices=ACTIVATE_TYPE, max_length=2)
    om_rain_option = models.IntegerField() # 단위 : 분
    om_high_temp_mode = models.CharField(choices=ACTIVATE_TYPE, max_length=2)
    om_high_temp_option = models.IntegerField() # 단위 : 섭씨
