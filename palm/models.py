...
class SensorInfoOrValue(models.Model):
    control_group = models.ForeignKey('ControlGroup', on_delete=models.PROTECT)
    # temp_id
    temp_num = models.IntegerField(default=0)
    ...
    # temp_value
    temp_value1 = models.FloatField(default=0)
    temp_value2 = models.FloatField(default=0)
    temp_value3 = models.FloatField(default=0)
    temp_mean = models.FloatField()
    # humd_id
    humd_num = models.IntegerField(default=0)
    ...
    # humd_value
    humd_value1 = models.FloatField(default=0)
    humd_value2 = models.FloatField(default=0)
    humd_value3 = models.FloatField(default=0)
    humd_mean = models.FloatField()
    # co2_id
    co2_num = models.IntegerField(default=0)
    ...
    # co2_value
    co2_value1 = models.FloatField(default=0)
    co2_value2 = models.FloatField(default=0)
    co2_value3 = models.FloatField(default=0)
    co2_mean = models.FloatField()
    # soil_temp_id
    soil_temp_num = models.IntegerField(default=0)
    ...
    # soil_temp_value
    soil_temp_value1 = models.FloatField(default=0)
    soil_temp_value2 = models.FloatField(default=0)
    soil_temp_value3 = models.FloatField(default=0)
    soil_temp_mean = models.FloatField()
    # soil_humd_id
    soil_humd_num = models.IntegerField(default=0)
    ...
    # soil_humd_value
    soil_humd_value1 = models.FloatField(default=0)
    soil_humd_value2 = models.FloatField(default=0)
    soil_humd_value3 = models.FloatField(default=0)
    soil_humd_mean = models.FloatField()
    # soil_ec_id
    soil_ec_num = models.IntegerField(default=0)
    ...
    # soil_ec_value
    soil_ec_value1 = models.FloatField(default=0)
    soil_ec_value2 = models.FloatField(default=0)
    soil_ec_value3 = models.FloatField(default=0)
    soil_ec_mean = models.FloatField()
    ...
    culture_medium_temp_value3 = models.FloatField(default=0)
    culture_medium_temp_mean = models.FloatField()
    # nutrient_solution_ec_id
    nutrient_solution_ec_num = models.IntegerField(default=0)
    ...
    nutrient_solution_ec_value1 = models.FloatField(default=0)
    nutrient_solution_ec_value2 = models.FloatField(default=0)
    nutrient_solution_ec_value3 = models.FloatField(default=0)
    nutrient_solution_ec_mean = models.FloatField()
    # nutrient_solution_ph_id
    nutrient_solution_ph_num = models.IntegerField(default=0)
    ...
    nutrient_solution_ph_value1 = models.FloatField(default=0)
    nutrient_solution_ph_value2 = models.FloatField(default=0)
