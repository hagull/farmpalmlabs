# Generated by Django 2.0.7 on 2019-01-07 19:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('og_name', models.IntegerField(default=0)),
                ('og_custom_name', models.CharField(max_length=50)),
                ('og_mode', models.CharField(blank=True, choices=[('01', '활성화'), ('02', '비활성화')], max_length=2)),
                ('og_tot', models.IntegerField(default=0)),
                ('og_ot', models.IntegerField(default=0)),
                ('og_lm_id', models.CharField(blank=True, max_length=6)),
                ('og_rm_id', models.CharField(blank=True, max_length=6)),
                ('control_group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='palm.ControlGroup')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('om_mode', models.CharField(blank=True, choices=[('01', '자동'), ('02', '수동')], max_length=2)),
                ('om_delay_time', models.IntegerField(default=0)),
                ('om_open_sequence', models.CharField(blank=True, choices=[('01', '1번 그룹부터'), ('02', '2번 그룹부터')], max_length=2)),
                ('om_close_sequence', models.CharField(blank=True, choices=[('01', '1번 그룹부터'), ('02', '2번 그룹부터')], max_length=2)),
                ('om_rain_mode', models.CharField(blank=True, choices=[('01', '활성화'), ('02', '비활성화')], max_length=2)),
                ('om_rain_option', models.IntegerField(default=0)),
                ('om_high_temp_mode', models.CharField(blank=True, choices=[('01', '활성화'), ('02', '비활성화')], max_length=2)),
                ('om_high_temp_option', models.IntegerField(default=0)),
                ('control_group', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='palm.ControlGroup')),
            ],
        ),
        migrations.CreateModel(
            name='ControlVMotorOption',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sw_ver', models.CharField(blank=True, max_length=2)),
                ('sensing_period', models.CharField(blank=True, max_length=6)),
                ('state', models.CharField(blank=True, choices=[('01', 'Normal'), ('02', 'Register Mode'), ('03', 'Battery Error'), ('04', 'Voltage Error'), ('05', 'Communication Error'), ('ff', 'Unknown Error')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date1', models.DateTimeField(blank=True)),
        ...
        migrations.AddField(
            ...
            name='control_group',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='palm.ControlGroup'),
        ),
        migrations.AddField(
            model_name='controletcoption',
            name='control_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='palm.ControlGroup'),
        ),
    ]
